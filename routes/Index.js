            ...
            for(var job of jobobj){
				...
				if(job.interview.length > 0 && !job.offerletter){
					...
					if(job.status === "interview-scheduled" || job.status === "rescheduled"){
						...
						if(job.interview[0].date.toDateString() === date2.toDateString()){
...
router.get("/user/:id/offerletter" , middleware.isLoggedin , function(req,res){
	  User.findById(req.params.id , async function(err , user){
		  if(err)
			  return console.log(err);
...
router.get("/api/user/:id/offerletter" , function(req,res){
	 User.findById(req.params.id , async function(err , user){
		  if(err)
			  return console.log(err);
...
router.get("/user/:id/offerletter/:jobid" , middleware.isLoggedin ,async function(req , res){
    if(req.params.id.toString() === req.user._id.toString()){
		// find job by their id
		 ...
		 var reciever = job.to;
		 var offerletter = job.offerletter;
...
router.get("/user/:id/interviews" , function(req,res){
	  User.findById(req.params.id , async function(err , user){
		  if(err)
			  return console.log(err);
...
router.get("/api/user/:id/interviews" , function(req,res){
	  User.findById(req.params.id , async function(err , user){
		  if(err)
			  return console.log(err);
...
router.post("/user/:id/profile" , middleware.isLoggedin ,  function(req ,res){
		  ...
		  if(req.body.fullname.length > 0){
			  ...
			  if(user.local.firstname){
				  ...
				  if(!lastindex){
				   ...
				   user.googleauth.fullname = req.body.fullname;
			   }else{
					user.linkedinauth.fullname = req.body.fullname;
			   }
			   user.save();
			  res.redirect("/user/" + req.user._id+ "/profile");
		  }else{
...
router.get("/user/:id/employer/candidates" , middleware.isLoggedin , function(req,res){
	  User.findById(req.params.id , async function(err , user){
		  if(err)
			  return console.log(err);
...
router.get("/api/user/:id/employer/candidates"  , function(req,res){
	  User.findById(req.params.id , async function(err , user){
		  if(err)
			  return console.log(err);
...
router.get("/user/:id/employer/offerletter" , middleware.isLoggedin , function(req,res){
	 User.findById(req.params.id , async function(err , user){
		  if(err)
			  return console.log(err);
		   if(user.role === "employer"){
...
router.get("/api/user/:id/employer/offerletter" , function(req,res){
	 User.findById(req.params.id , async function(err , user){
		  if(err)
			  return console.log(err);
...
router.get("/user/:id/employer/interviews" , middleware.isLoggedin , function(req,res){
	  User.findById(req.params.id , async function(err , user){
		  if(err)
			  return console.log(err);
...
router.get("/api/user/:id/employer/interviews" , middleware.isLoggedin , function(req,res){
	  User.findById(req.params.id , async function(err , user){
		  if(err)
			  return console.log(err);
...
router.get("/user/:id/employer/profile" , middleware.isLoggedin , function(req , res){
	User.findById(req.params.id  , function(err , user){
		if(err)
			return console.log(err);
